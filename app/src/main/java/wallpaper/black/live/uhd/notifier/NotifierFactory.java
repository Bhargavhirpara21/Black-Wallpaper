package wallpaper.black.live.uhd.notifier;
...
public class NotifierFactory {
     ...
     * Session events.
     */
    public static final int EVENT_NOTIFIER_UPDATE_LIST = 3;
    public static final int EVENT_UPDATE_BLACK_ACTIVITY = 6;
    public static final int EVENT_NOTIFIER_LIST = 4;
    public static final int EVENT_NOTIFIER_USER_INFO = 5;
    public static final int EVENT_NOTIFIER_AD_STATUS = 7;
