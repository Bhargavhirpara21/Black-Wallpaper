...
public class DoublePagerScrollListener extends RecyclerView.OnScrollListener {
    ...
    // Constructor
    public DoublePagerScrollListener(PagerSnapHelper snapHelper, @Type int type, boolean notifyOnInit, OnChangeListener listener) {
