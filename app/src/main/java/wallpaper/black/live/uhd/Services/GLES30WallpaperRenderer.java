...
class GLES30WallpaperRenderer extends GLWallpaperRenderer {
    ...
    public void onSurfaceCreated(GL10 gl10, EGLConfig eglConfig) {
        ...
        program = AppUtility.linkProgramGLES30(
                AppUtility.compileShaderResourceGLES30(
    ...
    void setScreenSize(int width, int height) {
        if (screenWidth != width || screenHeight != height) {
            screenWidth = width;
            screenHeight = height;
            LoggerCustom.erorr(TAG, String.format(
    ...
    private void updateMatrix() {
        ...
        if (videoRatio >= screenRatio) {
            LoggerCustom.erorr(TAG, "X-cropping");
            ...
            LoggerCustom.erorr(TAG, "Y-cropping");
